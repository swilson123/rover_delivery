...
var create_logs = function(rover)
	{
		...
		rover.logs.pozyx_message_handler = new rover.logging(rover, 'pozyx_message_handler');
		rover.logs.precision_landing = new rover.logging(rover, 'precision_landing');
		...
		rover.logs.robotkit = new rover.logging(rover, 'robotkit');
		rover.logs.ready_to_localize = new rover.logging(rover, 'ready_to_localize');
		rover.logs.video_stream = new rover.logging(rover, 'video_stream');
		rover.logs.video_broadcast = new rover.logging(rover, 'video_broadcast');
		rover.logs.mission_item_reached = new rover.logging(rover, 'mission_item_reached');
		rover.logs.deliver_package = new rover.logging(rover, 'deliver_package');
		rover.logs.update_delivery_altitude = new rover.logging(rover, 'update_delivery_altitude');
		rover.logs.request_new_mission = new rover.logging(rover, 'request_new_mission');
		rover.logs.update_travel_altitude = new rover.logging(rover, 'update_travel_altitude');
		...
		{
			//Retry connection...........
			rover.update_serialports(rover, false);
