...
mavlink_messages.prototype.MAV_CMD_CONDITION_YAW = function(rover, data)
{
	...
	if (data.param1)
	{
		request = new rover.mavlink.messages.command_long(rover.pixhawk_port.targetSystem, rover.pixhawk_port.targetComponent, rover.mavlink.MAV_CMD_CONDITION_YAW, 1, data.param1, 0, data.param3, data.param4, 0, 0, 0);
